...
let dataset = KnowledgeGraphDataset(path: "train-ke-small.txt", classes: "ke-classes.txt", device: device)
//var model = GCN(dataset: dataset)
var model = TransD(dataset: dataset)
...
//let trainer = ConvolutionTrainer(nEpochs: 10, batchSize: 3)
